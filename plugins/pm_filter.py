...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('⚜️𝐎𝐔𝐑 𝐌𝐀𝐈𝐍 𝐆𝐑𝐎𝐔𝐏⚜️', url='https://t.me/+SgufVcGFQsBjYmNl')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('ᴏᴜʀ ɢʀᴏᴜᴩ', url='https://t.me/+SgufVcGFQsBjYmNl'),
            
            InlineKeyboardButton('ɴᴇᴡ ᴍᴏᴠɪᴇꜱ', url='https://t.me/CINEMALOKAMM'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"📁 Found ✨  Files For Your Query : {search}"
